...
find the maximum average subarray which length should be
greater or equal to given length k.
It's guaranteed that the size of the array is greater or
equal to k.
Example
...
*/
    /**
     * @param nums an array with positive and negative
numbers
     * @param k an integer
