...
<pre>
/* 134. Gas Station
https://leetcode.com/problems/gas-
station/description/
...
costs cost[i] of gas
to travel from the ith station to its next (i +
1)th station. You
begin the journey with an empty tank at one of the
gas stations.
Given two integer arrays gas and cost, return the
starting gas station's
index if you can travel around the circuit once in
...
Output: 3
Explanation:
Start at station 3 (index 3) and fill up with 4
...
You cannot travel back to station 2, as it
requires 4 unit of gas but you only have 3.
Therefore, you can't travel around the circuit
