...
https://leetcode.com/problems/intersection-of-
three-sorted-arrays/
...
Example 1:
Input: arr1 = [1,2,3,4,5], arr2 = [1,2,5,7,9],
arr3 = [1,3,4,5,8]
Output: [1,5]
Explanation: Only 1 and 5 appeared in the three
arrays.
Example 2:
Input: arr1 = [197,418,523,876,1356], arr2 =
[501,880,1593,1710,1870], arr3 =
