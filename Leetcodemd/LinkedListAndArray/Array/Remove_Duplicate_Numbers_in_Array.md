...
Given an array of integers, remove the duplicate numbers in
it.
You should:
...
Actually we don't care about what you place in ?, we only
care about the part which has no duplicate integers.
Challenge
