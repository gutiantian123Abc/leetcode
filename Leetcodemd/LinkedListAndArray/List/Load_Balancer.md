...
<pre>
/*Load Balancer
Implement a load balancer for web servers. It provide the
...
add(3)
pick()
>> 1         // the return value is random, it can be either
1, 2, or 3.
pick()
>> 2
pick()
...
*/
     ...
     */
    /*
     * @param server_id: server_id remove a bad server from
the cluster
     * @return: nothing
     */
    /*
     * @return: pick a server in the cluster randomly with
equal probability
     */
</pre>
</div>
