...
<pre>
/* Decode String
Given an encoded string, return it's decoded
string.
...
Note that k is guaranteed to be a positive
integer.
...
does not contain any digits and that digits are
only for those repeat numbers,
k. For example, there won't be input like 3a or
2[4].
Examples:
