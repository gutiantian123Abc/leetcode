...
Write a function to generate the generalized
abbreviations of a word.
Example:
...
*/
/*
思路： 1. When keeping char,append num(>0) and add
char to solution, keep backtracking
      2. When abbreviating char, increase num and
keep backtracking
*/
</pre>
</div>
