...
The job is to output the lowest price you have to pay for exactly certain items
...
represents the price you need to pay for this special offer,
other numbers represents how many specific items you could get if you buy this
offer.
