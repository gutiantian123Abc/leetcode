...
to f.
The red-green-blue color "#AABBCC" can be written as "#ABC" in shorthand. For
example, "#15c" is
...
color is a valid RGB color: for i > 0, color[i] is a hexadecimal digit from 0 to
f
