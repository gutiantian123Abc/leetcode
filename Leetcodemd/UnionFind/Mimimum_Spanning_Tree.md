...
Given a list of Connections, which is the
Connection class
(the city name at both ends of the edge and a cost
between them),
 find some edges, connect all the cities and spend
the least amount.
Return the connects if can connect all the cities,
...
or sorted city1 name if their cost is same, or
sorted city2 if their city1 name is also same.
*/
/**
 ...
 */
    /**
     * @param connections given a list of
connections include two cities and cost
