...
1. connect(a, b), add an edge to connect node a
and node b. 2.query(a, b)`,
...
There is no edges in the graph at beginning.
You need to support the following method:
1. connect(a, b), an edge to connect node a and
node b
2. query(a), Returns the number of connected
...
1. connect(a, b), an edge to connect node a and
node b
2. query(), Returns the number of connected
