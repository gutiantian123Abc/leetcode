...
This enables a vehicle to enter through a different level(floor) and park at a completely different
floor
...
arise. Spot assignment is again based on strategy objects which decide which spot goes to which
